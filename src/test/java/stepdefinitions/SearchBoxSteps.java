...
public class SearchBoxSteps extends WebTestBase {
    ...
    public void userShouldBeAbleToEnterValidProductName() {
        searchBox.checkValidProductNameInSearchBoxFunctionality();
    }
    ...
    public void userShouldBeAbleToClickOnSearchButton() throws InterruptedException {
        searchBox.checkSearchButtonFunctionality();
        waitFor(5);
    }
    ...
    public void userShouldSeeTheValidProductAppears() throws InterruptedException {
        verifyText(searchBox.verifySearchProduct, "\"sunglasses\"", "text not match");
        waitFor(3);
    }
...
//        searchBox.enterProductName("Hand Sanitizer");
//    }
//
...
//        verifyText(searchBox.verifySearchedProduct, "\"Hand Sanitizer\"", "Product name does not match");
//    }
//
...
//        verifyText(searchBox.verifySearchedProduct, "\"" + expectedProduct + "\"", "Product name does not match");
//    }
//
